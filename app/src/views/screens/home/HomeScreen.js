...
function HomeScreen({navigation}) {
  ...
  // apply view
  const [applyView, setApplyView] = useState(1);
  ...
  const myAppliedJobs = id => {
    // setloading(true);
    var InsertAPIURL = base_url + '/student/myAppliedJobs.php';
    var headers = {
  ...
  const getClasses = id => {
    // setloading(true);
    var InsertAPIURL = base_url + '/student/getAllClass.php';
    var headers = {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    };
    ...
    <SafeAreaView
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Badge
            style={{
              backgroundColor: applyView == 0 ? COLORS.primary : COLORS.light,
            }}>
            My Applied Jobs
          </Badge>
        ...
        <TouchableOpacity
          onPress={() => {
           ...
           <Icon name="refresh" size={25} color={COLORS.light} />
